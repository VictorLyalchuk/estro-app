  ...
  function getPicker(picker, displayName) {
    ...
    const Picker = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
      ...
      const {
        ...
        restProps = __rest(props, ["prefixCls", "getPopupContainer", "style", "className", "rootClassName", "size", "bordered", "placement", "placeholder", "popupClassName", "dropdownClassName", "disabled", "status", "clearIcon", "allowClear", "variant"]);
      const {
        getPrefixCls,
        direction,
        getPopupContainer,
      ...
      return wrapCSSVar( /*#__PURE__*/React.createElement(_rcPicker.default, Object.assign({
        ref: innerRef,
        ...
        }, (0, _statusUtils.getStatusClassNames)(prefixCls, (0, _statusUtils.getMergedStatus)(contextStatus, customStatus), hasFeedback), hashId, compactItemClassnames, consumerStyle === null || consumerStyle === void 0 ? void 0 : consumerStyle.className, className, cssVarCls, rootCls, rootClassName),
        ...
        dropdownClassName: (0, _classnames.default)(hashId, cssVarCls, rootCls, rootClassName, popupClassName || dropdownClassName),
