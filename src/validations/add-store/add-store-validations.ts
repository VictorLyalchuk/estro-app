...
export const validateForm = (formData: IAddStoreData, selectedCountry: ICountry | null, selectedCity: ICity | null, setActiveTab: Dispatch<SetStateAction<number>>): { isValid: boolean; newErrors: Errors } => {
    let isValid = true;
