...
export const validateForm = (formData: IEditSubCategoryData, selectedMainCategory: IMainCategory | null, setActiveTab: Dispatch<SetStateAction<number>>): { isValid: boolean; newErrors: Errors } => {
    let isValid = true;
