...
import { AddSubCategoryProps } from '../../../../interfaces/Category/Sub-Category/AddSubCategoryProps';

const AddSubCategory_es: React.FC<AddSubCategoryProps> = (
        ...
        <div className="bg-white p-5 rounded-md shadow-md mb-8 mt-8 ">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-sm flex justify-center ">
                <div className="pb-6 mt-6">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">{t('Category_AddSubCategory')}</h2>
                </div>
            </div>
...
export default AddSubCategory_es;