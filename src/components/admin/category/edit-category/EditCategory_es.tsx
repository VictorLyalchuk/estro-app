...
import { EditCategoryProps } from '../../../../interfaces/Category/Category/EditCategoryProps';
import SubCategorySelect from '../../../../ui/category-select/SubCategorySelect';

const EditCategory_es: React.FC<EditCategoryProps> = (
    { formData, image, isUploading, errors,
        mainCategory, selectedMainCategory, handleMainCategoryChange,
        subCategory, selectedSubCategory, handleSubCategoryChange,
        ...
        <div className="bg-white p-5 rounded-md shadow-md mb-8 mt-8 ">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-sm flex justify-center ">
                <div className="pb-6 mt-6">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">{t('Category_Edit_SubCategory')}</h2>
                </div>
            </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <ThemeProvider theme={theme}>
                                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div className="sm:col-span-2">
                                        <label htmlFor="name_es" className="block text-sm font-medium text-gray-700 mb-2">
                                            {t('Category_Name')}
                                        </label>
                                        <TextFieldComponent
                                            label=""
                                    ...
                                    <div className="col-span-full">
                                        <label htmlFor="description_es" className="block text-sm font-medium text-gray-700 mb-2">
                                        ...
                                        <LongTextFieldComponents
                                            ...
                                            onChange={handleChange}
                                            error={errors.description_es ?? null}
                                            autoComplete="description_es"
                                        />
                                    </div>
...
export default EditCategory_es;