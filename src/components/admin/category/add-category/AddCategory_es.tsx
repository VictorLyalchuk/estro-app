...
import { AddCategoryProps } from '../../../../interfaces/Category/Category/AddCategoryProps';
import SubCategorySelect from '../../../../ui/category-select/SubCategorySelect';

const AddCategory_es: React.FC<AddCategoryProps> = (
        ...
        <div className="bg-white p-5 rounded-md shadow-md mb-8 mt-8 ">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-sm flex justify-center ">
                <div className="pb-6 mt-6">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">{t('Category_AddCategory')}</h2>
                </div>
            </div>
