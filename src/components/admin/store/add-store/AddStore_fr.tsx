...
const AddStore_fr: React.FC<AddStoreProps> = (
        ...
        <div className="bg-white p-5 rounded-md shadow-md mb-8 mt-8 ">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm flex justify-center ">
                <div className="pb-6 mt-6">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">{t('Store_AddStore')}</h2>
                </div>
            </div>
                        ...
                        <div className="border-b border-gray-900/10 pb-12">
                            <ThemeProvider theme={theme}>
                                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div className="sm:col-span-2">
                                        <label htmlFor="address_fr" className="block text-sm font-medium text-gray-700 mb-2">
                                            {t('Stores_Address')}
                                        </label>
                                        <TextFieldComponent
                                            label=""
                                            ...
                                            onChange={handleChange}
                                            error={errors.address_fr ?? null}
                                            autoComplete="address_fr"
                                            maxLength={30}
                                            placeholder={''}
                                        />
                                    </div>
