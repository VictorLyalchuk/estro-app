...
import { IProductEdit } from "../../../interfaces/Catalog/IProductEdit";
...
const EditProduct = () => {
    ...
    const [product, setProduct] = useState<IProductEdit>();
    ...
    useEffect(() => {
        axios.get<IProductEdit>(`${baseUrl}/api/Product/ProductByID/${Id}`)
            .then(async resp => {
    ...
    const onSubmit = async (values: any) => {
        ...
        try {
            await axios.post(`${baseUrl}/api/Product/EditProduct`, model, {
                headers: {
                    "Content-Type": "application/json"
                }
            });
