...
import { BagReducerActionType, IBagReducerState } from "./BagReducer";
...
const Bag = () => {
  ...
  return (
    <div className="bg-gray-100">
      <div className="container mx-auto p-8 flex  relative bg-gray-100 mx-auto max-w-7xl px-2 sm:px-2 lg:px-2   flex-col lg:flex-row justify-between border-b">
                  ...
                  <div className="border-t pt-4 flex ">
                    ...
                    <div className="w-1/2 ml-4">
                      ...
                      <div className="flex items-center ml-auto mt-6">
                        <button className="bg-gray-200 text-gray-700 px-3 py-1 rounded-md mr-2 hover:bg-gray-300">
                          <MinusIcon className="h-5 w-3" onClick={() => decrease(item)} />
                        </button>
                        <span className="mx-2 w-3">{item.quantity}</span>
                        <button className="bg-gray-200 text-gray-700 px-3 py-1 rounded-md ml-2 hover:bg-gray-300">
                          <PlusIcon className="h-5 w-3 " onClick={() => increase(item)} />
