...
const BranchShipping: React.FC<BranchShippingProps> = ({ cityOptions, warehouseOptions, handleChangeCity, handleChangeWarehouse, warehouseSelected, selectedWarehouseOptions, errors }) => (
    <div className="mt-5">
