...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`bg-gray-100 border-r absolute left-0 top-0 z-9999 flex  w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 ">
        <NavLink to="/dashboard">
          {/* <img src="../images/estro2.webp" alt="Your Company" /> */}
          <h1 className="text-black text-8xl mb-1 mt-10 hover:text-indigo-300 text-center">estro</h1>
        </NavLink>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <h1 className="mb-4 ml-4 text-sm font-semibold text-bodydark2 mb-1 mt-10 hover:text-indigo-300 ">
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to=""
                              className={`hover:text-indigo-300 group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('profile') && 'bg-graydark dark:bg-meta-4'
                                }`}
                            >
                              <svg
                                className="fill-current"
                          ...
                          <li>
                            <NavLink
                              to="tables"
                              className={`hover:text-indigo-300 group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('tables') && 'bg-graydark dark:bg-meta-4'
                                }`}
                            >
                              <svg
                                className="fill-current"
              ...
              <li>
                <NavLink
                  to="settings"
                  className={`hover:text-indigo-300 group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('settings') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
