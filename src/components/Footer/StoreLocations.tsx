          ...
          <div className=" p-4 bg-transparent cursor-pointer">
            ...
            {cities.map(city => (
              <a
                ...
                className={`text-gray-700 py-2 px-4 w-full rounded-md focus:outline-none hover:text-indigo-500 ${selectedCity === city ? 'bg-indigo-500 text-white hover:text-white' : 'bg-transparent'
                  }`}
              >
                {city}
              </a>
