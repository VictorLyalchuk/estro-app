...
import { BagReducerActionType, IBagReducerState } from '../Bag/BagReducer.tsx';
                                        ...
                                        <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                                            <div className="flow-root">
                                                <div className="-m-2 block p-2 font-medium text-gray-900">
                                                    <Link to={"/"} onClick={handleLogout}>Logout ({user?.Email})</Link>
                                                </div>
                                            </div>
                                        </div>
                                    ) : (
                                                            ...
                                                            <div className="relative flex ">
                                                                <Popover.Button
                                                                    className={classNames(
                                                                        ...
                                                                        'relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out hover:text-indigo-500'
                                                                    )}
                                                                >
                                                                    {category.name}
                                                                </Popover.Button>
                                        ...
                                        <div className="ml-4 flow-root lg:ml-6">
                                            <a href="#" className="group -m-2 flex items-center p-2">
                                                ...
                                                <Link to={"/bag"} className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800 w-20 flex items-center">
                                                    ...
                                                    />
                                                    {count}</Link>
                                                {/* <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-800 w-20">{count}</span> */}
