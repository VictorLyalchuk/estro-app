...
const WomanSizeGuideComponent: React.FC<SizeGuideProps> = ({ isOpen, setOpen }) => {
                                    ...
                                    <div className="mt-2 min-h-[550px]">
                                        <div className={`tab-content ${activeTab === 0 ? 'block' : 'hidden'}`}>
                                            <table className="table-auto w-full">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td className="border px-4 py-4 text-center">35</td>
                                                        <td className="border px-4 py-4 text-center">22.5</td>
                                                        <td className="border px-4 py-4 text-center">{t('Product_To')} 22.3</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="border px-4 py-4 text-center">36</td>
                                                        <td className="border px-4 py-4 text-center">23.0</td>
                                                        <td className="border px-4 py-4 text-center">{t('Product_To')} 22.8</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="border px-4 py-4 text-center">37</td>
                                                        <td className="border px-4 py-4 text-center">23.5</td>
                                                        <td className="border px-4 py-4 text-center">{t('Product_To')} 23.0</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="border px-4 py-4 text-center">38</td>
                                                        <td className="border px-4 py-4 text-center">24.5</td>
                                                        <td className="border px-4 py-4 text-center">{t('Product_To')} 24.2</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="border px-4 py-4 text-center">39</td>
                                                        <td className="border px-4 py-4 text-center">25.0</td>
                                                        <td className="border px-4 py-4 text-center">{t('Product_To')} 24.7</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="border px-4 py-4 text-center">40</td>
                                                        <td className="border px-4 py-4 text-center">25.5</td>
                                                        <td className="border px-4 py-4 text-center">{t('Product_To')} 25.2</td>
                                                    </tr>
                                                    <tr>
                                                        <td className="border px-4 py-4 text-center">41</td>
                                                        <td className="border px-4 py-4 text-center">26.0</td>
                                                        <td className="border px-4 py-4 text-center">{t('Product_To')} 25.7</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
...
export default WomanSizeGuideComponent;